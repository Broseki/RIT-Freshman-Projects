...
/**
 * Represents a node in a De-Quattor-Unum (DQU) tree for an image compressed
 * using the DQU file format.
 * <p>
...
public class DQUNode {
     ...
     */
    private final Map< Quadrant, DQUNode > children;
     ...
     */
    public DQUNode( DQUNode... children ) {
        this.value = -1;
     ...
     */
    public DQUNode getChild( Quadrant quadrant ) {
        return this.children.get( quadrant );
    }

    /**
     * Get a string suitable for displaying the entire DQU tree.
     * @see QTree#toString()
     *
