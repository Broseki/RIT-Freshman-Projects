/**
 * DeQuattorUnum compressor.  This program takes a raw image file of
 * grayscale values (0-255) and compresses them into the DQU format.
...
public class DQUCompress {
    ...
    public static void main( String[] args ) {
        if ( args.length != 2 ) {
            System.err.println(
                    "Usage: java DQUCompress input-file output-file" );
            return;
        }
